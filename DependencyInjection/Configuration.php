    ...
    $rootNode
      ->children()
        ->arrayNode('classes')->addDefaultsIfNotSet()
          ->children()
            ->arrayNode('help')->defaultValue(['text-muted'])->end()
            ->arrayNode('dev')->defaultValue(['text-muted'])->end()
            ->arrayNode('alerts_ul')->defaultValue([])->end()
            ->arrayNode('alerts_li')->defaultValue(['alert', 'alert-danger'])->end()
          ->end()
        ->end()
